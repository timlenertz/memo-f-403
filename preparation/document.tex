...
Une première étape à effectuer pour pouvoir faire de mesures photogrammétriques est la calibration. Elle consiste à déterminer les paramètres extrinsèques et intrinsèques de la caméra avec laquelle les photos one été pris. Les \emph{paramètres extrinsèques} sont la position et l'orientation de la caméra par rapport à l'environnement. Dans un repère donné, ils peuvent être définis par les coordonnées $(x_0, y_0, z_0)$ et les angles d'Euler $(\omega, \phi, \kappa)$. Les \emph{paramètres intrinsèques} consistent 


\section{Combination photo-nuage de points}
